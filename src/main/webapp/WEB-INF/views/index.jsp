        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">100% Fresh and Pure Milk</h4>
                    <h1 class="mb-5 display-3 text-primary">Organic Dairy Products & Fresh Milk</h1>
                </div>
                <div class="col-md-12 col-lg-5">
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="img/hero-img-1-2.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
