                    ...
                    <div class="row g-4">
                        <div class="col-xl-3">
                            <div class="input-group w-100 mx-auto d-flex">
                                <form:form action="/product-list" method="GET" modelAttribute="productSearch" cssClass="w-100 d-flex">
                                    <form:input class="form-control p-3 flex-grow-1" path="productName" placeholder="Search by name..." aria-describedby="search-icon-1"/>
                        ...
                        <div class="col-xl-3">
                            <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
                                <form:form action="/product-list" method="GET" modelAttribute="productSearch" cssClass="w-100 d-flex">
                                    <label class="form-label" for="fruits">Default Sorting:</label>
                                    <form:select path="sortCriteria" class="border-0 form-select-sm bg-light me-3" id="fruits" >
                                        <form:option value="Nothing"/>
                                        <form:option value="Popularity"/>
                                    </form:select>
                                </form:form>
                            </div>
                        </div>
