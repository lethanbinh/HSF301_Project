...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <form id="checkout-form" action="/checkout/payment" method="POST">
                        ...
                        <tbody>
                            <c:forEach var="cartItem" items="${sessionScope.CART}">
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4"><fmt:formatNumber value="${cartItem.quantity * cartItem.itemPrice}" type="number" minFractionDigits="2" maxFractionDigits="2"/> $</p>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Your order has been placed successfully! If you close this form, you will be navigated to your order history!
                </div>
    ...
    <script src="js/main.js"></script>
     ...
     $(document).ready(function() {
         ...
         // Redirect to manage-order page when the modal is closed
         $('#successModal').on('hidden.bs.modal', function () {
             window.location.href = '/manage-order';
         });

         // Ensure the modal can be closed by clicking the 'x' button or the close button
